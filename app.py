...
# Malicious URL sample data
malicious_url_sample = {
...
# Button to generate malicious URL and test it
if st.button("Generate a Malicious URL"):
    st.write("Generated Malicious URL: ", malicious_url_sample["URL"])
    extracted_features = malicious_url_sample
    feature_values = np.array([[extracted_features[key] for key in extracted_features]])
